...
#[derive(Debug)]
pub struct ModernGlassProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ModernGlassProcessor {
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ModernGlassProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ModernGlassProcessor::new(false);
